...
instance Print Stmt where
  prt i e = case e of
    SVarDef dec -> prPrec i 0 (concatD [prt 0 dec, doc (showString ";")])
    SFunDef dec decs stmt -> prPrec i 0 (concatD [prt 0 dec, doc (showString "("), prt 0 decs, doc (showString ")"), prt 0 stmt])
    ...
    SExpStmt exp -> prPrec i 0 (concatD [prt 0 exp, doc (showString ";")])
...
instance Print Exp where
  prt i e = case e of
    EILit n -> prPrec i 8 (concatD [prt 0 n])
    ...
    EApp id exps -> prPrec i 8 (concatD [prt 0 id, doc (showString "("), prt 0 exps, doc (showString ")")])
    EIncr exp -> prPrec i 7 (concatD [prt 8 exp, doc (showString "++")])
    EDecr exp -> prPrec i 7 (concatD [prt 8 exp, doc (showString "--")])
    ...
    EPlus exp1 exp2 -> prPrec i 5 (concatD [prt 5 exp1, doc (showString "+"), prt 6 exp2])
    EMinus exp1 exp2 -> prPrec i 5 (concatD [prt 5 exp1, doc (showString "-"), prt 6 exp2])
